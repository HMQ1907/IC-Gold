    ...
    <div class="bg-gray-800/50 border border-gray-700 rounded-2xl p-6 sm:p-8">
      <form @submit.prevent="onSubmit" class="space-y-5">
        ...
        <button
          type="submit"
          :disabled="loading"
          class="w-full py-3 px-4 bg-amber-500 hover:bg-amber-600 disabled:bg-amber-500/50 disabled:cursor-not-allowed text-gray-900 font-semibold rounded-xl transition-colors flex items-center justify-center gap-2"
        >
