    ...
    <div v-else class="space-y-6">
      ...
      <div class="bg-gray-900/80 backdrop-blur border border-gray-800 rounded-2xl overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-800 bg-gray-800/50">
          <div class="flex items-center gap-3">
            ...
            <h3 class="text-white font-semibold">Cài đặt ví TRC20</h3>
          </div>
        </div>
        <div class="p-6 space-y-4">
          <div>
            <label class="block text-sm font-medium text-gray-300 mb-2">Địa chỉ ví nhận tiền nạp TRC20</label>
            <input 
              v-model="settings.trc20_wallet_address" 
              placeholder="Txxx..." 
          ...
          <p class="text-gray-300 text-sm">Hoặc vào <NuxtLink to="/admin/wallets" class="text-amber-500 hover:underline">Quản lý ví TRC20</NuxtLink> để chọn ví từ danh sách có sẵn.</p>
        </div>
      </div>
      ...
      <div class="bg-gray-900/80 backdrop-blur border border-gray-800 rounded-2xl overflow-hidden">
        ...
        <div class="p-6">
          <div class="grid md:grid-cols-2 gap-4">
            <div>
              <label class="block text-sm font-medium text-gray-300 mb-2">Nạp tối thiểu ($)</label>
              <input 
            ...
            <div>
              <label class="block text-sm font-medium text-gray-300 mb-2">Rút tối thiểu ($)</label>
              <input 
      ...
      <div class="bg-gray-900/80 backdrop-blur border border-gray-800 rounded-2xl overflow-hidden">
        ...
        <div class="p-6">
          <div class="grid md:grid-cols-2 gap-4">
            <div>
              <label class="block text-sm font-medium text-gray-300 mb-2">Thưởng giới thiệu ($)</label>
              <input 
            ...
            <div>
              <label class="block text-sm font-medium text-gray-300 mb-2">Số lần giới thiệu tối đa</label>
              <input 
      ...
      <div class="bg-gray-900/80 backdrop-blur border border-gray-800 rounded-2xl overflow-hidden">
        ...
        <div class="p-6">
          <div class="grid md:grid-cols-2 gap-4">
            <div>
              <label class="block text-sm font-medium text-gray-300 mb-2">Số dư tối thiểu cho Copy Trade ($)</label>
              <input 
            ...
            <div>
              <label class="block text-sm font-medium text-gray-300 mb-2">Phần trăm Copy Trade mặc định (%)</label>
              <input 
      ...
      <div class="bg-gray-900/80 backdrop-blur border border-gray-800 rounded-2xl overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-800 bg-gray-800/50">
          <div class="flex items-center gap-3">
            <div class="w-10 h-10 bg-cyan-500/20 rounded-xl flex items-center justify-center">
              <UIcon name="i-heroicons-globe-alt" class="w-5 h-5 text-cyan-500" />
            </div>
        ...
        <div class="p-6 space-y-4">
          ...
          <div class="grid md:grid-cols-2 gap-4">
            ...
            <div>
              <label class="block text-sm font-medium text-gray-300 mb-2">Link Telegram hỗ trợ</label>
              <input 
